...
public class RegisterScreenBase extends AnchorPane {
    ...
    public RegisterScreenBase() {
        ...
        coverImageView.setFitHeight(1000.0);
        coverImageView.setFitWidth(2000.0);
        coverImageView.setPickOnBounds(true);
        coverImageView.setPreserveRatio(true);
        coverImageView.setImage(new Image(getClass().getResource("/assets/cover.png").toExternalForm()));
